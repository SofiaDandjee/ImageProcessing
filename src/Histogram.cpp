...
ImageHistogram Histogram::computeImageHistogram(const RGBImage& image) const {
...
ChannelHistogram Histogram::computeChannelHistogram(const Channel& channel) const {
