...
void WriteImageHistogram(const ImageHistogram& imageHisto, string filename) {
...
void WriteChannelHistogram(const ChannelHistogram& channelHisto, string filename) {
