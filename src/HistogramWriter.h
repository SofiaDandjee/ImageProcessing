 ...
 */
void WriteImageHistogram(const ImageHistogram& imageHisto, std::string filename);
 ...
 */
void WriteChannelHistogram(const ChannelHistogram& channelHisto, std::string filename);
